...
public interface EmployeeRepository extends JpaRepository<Employee, Integer> {
    ...
    /**
     * This method returns a list as there can be multiple top level employees. If
     * anyone without a manager is considered as a top level employee.
     * 
     * @return list of top level employees and the hierarchy
     */
